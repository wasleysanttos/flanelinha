 ...
 */
public class HistoricoVagasAdapter extends BaseAdapter {
    Context ctx;
    ArrayList<Vaga> vagascadastras;

    public HistoricoVagasAdapter(Context ctx, ArrayList<Vaga> vagas) {
        this.ctx = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(ctx).inflate(R.layout.historico_vagas_adapter, null);
